...
#for some reason the lbp file didn't come with opencv and had to be downloaded. because of this I had to put the absolute path in, which is gross
...
# If no faces are found the entire 5 seconds it locks the machine
def checkcam():
    ...
    #That means the user is using the webcam for another app and we probably shouldn't lock the machine
    try:
